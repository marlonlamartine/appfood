...
<div class="form-group">
    ...
    <input type="text" name="name" class="form-control" placeholder="Informe um nome" value="{{ $tenant->name ?? old('name') }}">
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <input type="email" name="email" class="form-control" placeholder="Informe um email" value="{{ $tenant->email ?? old('email') }}">
</div>
<div class="form-group">
    <label for="cnpj">* CNPJ:</label>
    <input type="number" name="cnpj" class="form-control" placeholder="Informe um cnpj" value="{{ $tenant->cnpj ?? old('cnpj') }}">
</div>
<div class="form-group">
